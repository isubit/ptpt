	...
	return (
		<div className="WelcomeModal grid-row">
			<div className="grid-wrap">
				<Link to="/"><img className="CloseButton" src="../../assets/close_dropdown.svg"></img></Link>
				...
				<p className="modal-text">To get started, you can use your current location, 
					...
					If you need additional help, you can read the <Link to="/help">help documentation</Link>.
				</p>
				<div>
