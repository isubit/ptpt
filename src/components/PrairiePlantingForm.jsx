...
// const PrairieManagementInput = (props) => {

// }

// const PrairieSystemsInput = (props) => {

// }

// export class PrairiePlantingModal extends React.component {
// 	// set up state
// 	// set up configForm components
// 	// set up controlled components, set up input change handlers
// 	// render configForm components in class (similarly like treeplantingmodal)
// 	constructor(props) {
// 		super(props);

// 		const { editingFeature } = props;

// 		const type = editingFeature.properties.type || 'prairie';
